 ...
 * caller (derived server-side from the session user — the client
 * never sends a technician id). Supports status filtering and
 * pagination. Parts, approvals and notifications arrive in later
...
@Component({
  ...
  templateUrl: './technician-jobs.html',
})
